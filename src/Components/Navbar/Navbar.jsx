...
export default function Navbar() {
  ...
  return (
      ...
      <header
        ref={menuRef}
        className="flex flex-wrap md:flex-nowrap justify-center w-full py-2 md:py-5 border-0 bg-[#242833] border-neutral-200 md:relative md:z-10"
      >
        <div className="flex items-center  h-full max-w-[1536px] w-full px-4 md:px-10">
          <SfButton
              ...
              <li role="none">
                ...
                >
                  <SfDrawer
                    ...
                    disableClickAway
                    placement="top"
                    className="grid z-50 grid-cols-1 md:gap-x-6 md:grid-cols-4 bg-white shadow-lg p-0 max-h-screen overflow-y-auto md:!absolute md:!top-20 max-w-[376px] md:max-w-full md:p-6 mr-[50px] md:mr-0"
                  >
